...
#打开词典文件，返回列表
def open_dict(Dict = 'hahah', path='C:/pypro/Textming/Textming/'):
...
deny_word = open_dict(Dict = '否定词', path= r'C:/pypro/Textming/Textming/')
posdict = open_dict(Dict = 'positive', path= r'C:/pypro/Textming/Textming/')
negdict = open_dict(Dict = 'negative', path= r'C:/pypro/Textming/Textming/')
degree_word = open_dict(Dict = '程度级别词语', path= r'C:/pypro/Textming/Textming/')
